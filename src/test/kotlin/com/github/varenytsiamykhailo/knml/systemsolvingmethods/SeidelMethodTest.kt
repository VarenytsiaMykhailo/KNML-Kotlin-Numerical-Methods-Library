...
internal class SeidelMethodTest {

    @Test
    fun test1SolveSystemBySeidelMethod() {
        ...
        assert(result.arrayResult!![0].toString().startsWith("1.000247"))
        assert(result.arrayResult!![1].toString().startsWith("1.000031"))
        assert(result.arrayResult!![2].toString().startsWith("0.999922"))
        assert(result.vectorResult != null)
        assert(result.vectorResult!!.getN() == 3)
        assert(result.vectorResult!!.getElem(0).toString().startsWith("1.000247"))
        assert(result.vectorResult!!.getElem(1).toString().startsWith("1.000031"))
        assert(result.vectorResult!!.getElem(2).toString().startsWith("0.999922"))
    ...
    @Test
    fun test2SolveSystemBySeidelMethod() {
        val A: Matrix = Matrix(
            arrayOf(
                arrayOf(115.0, -20.0, -75.0),
                arrayOf(15.0, -50.0, -5.0),
    ...
    @Test
    fun test3SolveSystemBySeidelMethod() {
        val A: Matrix = Matrix(
            arrayOf(
        ...
        assert(result.arrayResult!![0].toString().startsWith("0.8"))
        ...
        assert(result.vectorResult!!.getElem(0).toString().startsWith("0.8"))
     ...
     */
    @Test
    fun test4SolveSystemBySeidelMethod() {
        val A: Matrix = Matrix(
            arrayOf(
                arrayOf(20.9, 1.2, 2.1, 0.9),
                arrayOf(1.2, 21.2, 1.5, 2.5),
     ...
     */
    @Test
    fun test5SolveSystemBySeidelMethod() {
        val A: Matrix = Matrix(
            arrayOf(
                arrayOf(20.9, 1.2, 2.1, 0.9),
                arrayOf(1.2, 21.2, 1.5, 2.5),
     ...
     */
    @Test
    fun test6SolveSystemBySeidelMethod() {
        val A: Matrix = Matrix(
            arrayOf(
                arrayOf(20.9, 1.2, 2.1, 0.9),
                arrayOf(1.2, 21.2, 1.5, 2.5),
     ...
     */
    @Test
    fun test7SolveSystemBySeidelMethod() {
        val A: Matrix = Matrix(
            arrayOf(
                arrayOf(20.9, 1.2, 2.1, 0.9),
                arrayOf(1.2, 21.2, 1.5, 2.5),
     ...
     */
    @Test
    fun test8SolveSystemBySeidelMethod() {
        val A: Matrix = Matrix(
            arrayOf(
                arrayOf(20.9, 1.2, 2.1, 0.9),
                arrayOf(1.2, 21.2, 1.5, 2.5),
